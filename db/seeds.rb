...
algo = Cryptocoin.create(name: 'algorand', dollar_value: 1.26, abv: 'ALGO', description: 'Algorand (ALGO) is a public blockchain that uses a unique consensus mechanism, called pure proof-of-stake. The company claims that it offers high scalability and that it prevents forks from happening. Algorand makes it simple and fast for developers to build on blockchain; you can build applications on Algorand in your preferred programming languages.')
ceth = Cryptocoin.create(name: 'compound ether', dollar_value: 70.35, abv: 'CETH', description: 'Compound is a protocol on the Ethereum blockchain that establishes money markets, which are pools of assets with algorithmically derived interest rates, based on the supply and demand for the asset. Suppliers (and borrowers) of an asset interact directly with the protocol, earning (and paying) a floating interest rate, without having to negotiate terms such as maturity, interest rate, or collateral with a peer or counterparty.')
dai = Cryptocoin.create(name: 'dai', dollar_value: 0.99, abv: 'DAI', description: 'Dai (DAI) is a stable, decentralized currency. It is created via the Makers (MKR) Dai Stablecoin System. It uses margin trading to respond to changing market conditions and preserve its value against the major world currencies. Unlike other stablecoins whose value is backed directly by USD, Dai is backed by crypto collaterals that can be viewed publicly on the Ethereum blockchain.')
